        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-8 leading-relaxed">
              Condiții favorabile de leasing pentru viitoarea ta mașină
            </h1>
            <div className="max-w-3xl mx-auto space-y-4 text-muted-foreground">
              <p className="text-lg">
                Planifici să îți achiziționezi un automobil prin leasing?
              </p>
              <p className="text-lg">
                Oferim consultare dedicată și asistență profesională pentru obținerea celui mai potrivit leasing.
              </p>
          ...
          <Card className="mb-8 border-auto-green/20 bg-auto-green/5">
            <CardContent className="p-6">
              <p className="text-center text-muted-foreground">
                *Orice mașină din gama noastră poate fi achiziționată prin leasing, 
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-center text-foreground mb-8">
              Condiții generale de eligibilitate pentru leasing
            </h2>
              ...
              <Card className="border-0 shadow-card">
                <CardHeader className="bg-gradient-primary text-white rounded-t-lg">
                  <CardTitle className="flex items-center text-xl">
                    ...
                    Pentru persoane fizice – leasing „Automobil personal"
                  </CardTitle>
                </CardHeader>
              ...
              <Card className="border-0 shadow-card">
                <CardHeader className="bg-auto-green text-white rounded-t-lg">
                  <CardTitle className="flex items-center text-xl">
                    ...
                    Pentru persoane juridice – „Leasing pentru companii"
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-6 space-y-6">
                  <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            ...
            <Card className="border-0 shadow-card text-center">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">Asistență profesională pentru cea mai bună soluție de leasing</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-card text-center">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">Proceduri rapide și transparente pentru aprobarea leasingului</p>
              </CardContent>
            </Card>
          </div>
        </div>
