  ...
  const onSubmit = async (data: CarListingFormData) => {
    ...
    try {
      const carData = {
        ...
        greutatea_masinii: data.greutatea_masinii ? Number(data.greutatea_masinii) : null,
        sarcina_incarcata: data.sarcina_incarcata ? Number(data.sarcina_incarcata) : null,
        pret_total: data.pret_total ? Number(data.pret_total) : null,
